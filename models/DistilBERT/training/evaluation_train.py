...
model = DistilBertForSequenceClassification.from_pretrained('models/DistilBERT/output/trained')

# Maximum Length of tokens in every post.
token_lengths = []
for token in posts:
...
# Setting up for the StratifiedKFold.
...
# Evalues the trained DistillBERT model.
